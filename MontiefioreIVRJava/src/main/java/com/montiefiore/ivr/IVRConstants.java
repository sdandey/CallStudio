package com.montiefiore.ivr;

public class IVRConstants {

	public static final String SETTINGS_DISPLAYFOLDERNAME = "Montiefiore";
	
	public static final String SETTINGS_DNISNUMBER = "Dnis";
	
	public static final String EXITSTATE_OPEN = "Open";
	
	public static final String EXITSTATE_CLOSED = "Closed";

	public static final String SETTINGS_CALLTYPE_ENGLISH = "CallType English";
	
	public static final String SETTINGS_CALLTYPE_SPANISH = "CallType Spanish";
	
	public static final String S_ISSPANISHSELECTED = "S_IsSpanishSelected";
